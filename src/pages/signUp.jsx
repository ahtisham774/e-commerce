        ...
        <div className='flex flex-col gap-5 lg:max-w-sm w-full'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-5 w-full'>
            ...
            <div className='flex items-center gap-1 mb-4'>
              <input
                type='checkbox'
                className='border-2 -mt-2 accent-[#EEDFE2] rounded-md size-6 active:hover:accent-[#EEDFE2] focus:outline-none'
              />
              <p className='text-xs font-normal'>
          ...
          <div className='flex items-center gap-4'>
            <button onClick={handleGoogle} className='p-3 bg-white border-2 text-base font-semibold rounded-lg w-full focus:outline-none flex items-center gap-3 justify-center'>
              <svg
                width='21'
                height='20'
                viewBox='0 0 21 20'
            ...
            <button onClick={handleFacebook} className='p-3 bg-white border-2 text-base font-semibold rounded-lg w-full focus:outline-none flex items-center gap-3 justify-center'>
              <svg
                width='21'
                height='20'
                viewBox='0 0 21 20'
          ...
          <div className='flex items-center justify-center gap-2 text-sm'>
            ...
            <Link to='/login' className='font-semibold text-[#ED0A8A]'>
              Log In
            </Link>
          </div>
        </div>
